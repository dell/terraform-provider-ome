...
After the execution of above resource block, template deployment would have been finished on the OME. For more information, Please check the terraform state file.
