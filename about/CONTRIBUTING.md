...
All issues related to the associated terraform providers should be submitted [here](https://github.com/dell/terraform-provider-ome/issues). Issues will be triaged and labels will be used to indicate the type of issue. This section outlines the types of issues that can be submitted.  
...
Before submitting a new issue, make sure someone hasn't already reported the problem. Look through the [existing issues](https://github.com/dell/terraform-provider-ome/issues) for similar issues.

Report a bug by submitting a [bug report](https://github.com/dell/terraform-provider-ome/issues/new?labels=type%2Fbug%2C+needs-triage&template=bug_report.md&title=%5BBUG%5D%3A). Make sure that you provide as much information as possible on how to reproduce the bug.

When opening a Bug please include the following information to help with debugging:

1. Version of relevant software: provider, terraform, go, OpenManage Enterprise Versions, etc.
...
If you have an idea of how to improve this project, submit a [feature request](https://github.com/dell/terraform-provider-ome/issues/new?labels=type%2Ffeature-request%2C+needs-triage&template=feature_request.md&title=%5BFEATURE%5D%3A).

### Answering questions

If you have a question and you can't find the answer in the documentation or issues, the next step is to submit a [question.](https://github.com/dell/terraform-provider-ome/issues/new?labels=type%2Fquestion&template=ask-a-question.md&title=%5BQUESTION%5D%3A)
...
If you don't have the knowledge or time to code, consider helping with _issue triage_. The Dell Terraform community will thank you for saving them time by spending some of yours.
...
* [Beginner-friendly](https://github.com/dell/terraform-provider-ome/issues?q=is%3Aopen+is%3Aissue+label%3A%22beginner+friendly%22) issues are generally straightforward to complete.
* [Help wanted](https://github.com/dell/terraform-provider-ome/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) issues are problems we would like the community to help us with regardless of complexity.

When you're ready to contribute, it's time to create a pull request.

## Testing
For running unit test, run the following command from the project root directory
```
go test -v ./clients -cover -timeout 30m
```

For running acceptance/integration test, run the following command from the project root directory
```
go test -v ./ome -timeout 2h -cover
```

**_Note:_** You need to set all the required environment variables for integration tests to run.
```
OME_HOST = 198.168.0.1
...
[GitHub action](https://github.com/hashicorp/terraform-plugin-docs/) that runs go generate to identify Unexpected difference in directories after code generation.
